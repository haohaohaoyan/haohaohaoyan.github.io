...
run locally by cloning the repo, hosting it on a local server (like vscode's live server plugin), and then access it through the hosting link on your favorite browser! the main page is at index.html.
